...
class Controls
{
	...
	public function render()
	{
		...
		$row = "<div class='block b-70'><h2>Paso 1:{$display_view}</h2></n><b>Selecciona tu Sala de estudio</b></div><div class='block b-30' style='text-align:right'>{$session_view}</div>";
