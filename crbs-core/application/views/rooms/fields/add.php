...
<fieldset>
	...
	<legend accesskey="F" tabindex="<?= tab_index() ?>">Detalles del campo</legend>
	...
	<div class="dropdown_options" <?= $options_attrs ?>>
		<p>
			...
			?><p class="hint">Ingrese aquí las opciones seleccionables para la lista desplegable; uno en cada línea.</p>
		</p>
		<?php echo form_error($input_name); ?>
	</div>
