...
<fieldset>
	...
	<legend accesskey="G" tabindex="<?= tab_index() ?>">Grupo Salas</legend>
...
<fieldset>
	...
	<legend accesskey="R" tabindex="<?= tab_index() ?>">Salas</legend>

	<div>Elija qué sala pertenecen a este grupo.</div>
	<br>
...
$this->load->view('partials/submit', array(
	...
	'cancel' => array('Cancelar', tab_index(), 'room_groups'),
));
