...
<fieldset>
	...
	<legend accesskey="A">Entrada de control de acceso</legend>
	...
	<?php $field = 'target_id'; ?>
	<p>
		<label for="target_id">Sala</label>
		<?php
		$options = array('' => '');
		if ($rooms) {
	...
	<p data-xax="on change add .hidden to .actor-choice
		...
		// );
		$options = [
			['value' => 'A', 'label' => 'Cualquier usuario que haya iniciado sesión'],
			['value' => 'D', 'label' => 'Carrera'],
		];
	...
	<div class="submit" style="border-top:0px;">
		<?php
		echo form_submit(array('value' => 'Agregar'));
