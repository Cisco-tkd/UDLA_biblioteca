...
<table width="100%" cellpadding="2" cellspacing="2" border="0" class="border-table table-align-vat" up-data='<?= json_encode($sort_cols) ?>' id="access_control_list" up-hungry>
	...
	<thead>
	<tr class="heading">
		<td class="h" width="20%" title="Room">Sala</td>
		<td class="h" width="40%" title="Who">Acceso</td>
		<td class="h" width="10%" title="Permission">Permisos</td>
	...
	<?php else: ?>
		...
		<tbody>
			<tr>
				<td colspan="5" align="center" style="padding:16px 0">¡No se encontraron entradas de control de acceso!</td>
			</tr>
		</tbody>
