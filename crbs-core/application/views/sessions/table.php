...
>
	...
	<thead>
		<tr class="heading">
			<td class="h" width="20%" title="Name">Nombre</td>
			<td class="h" width="10%" title="Current?">¿Actual?</td>
			<td class="h" width="10%" title="Available?">¿Disponible?</td>
			<td class="h" width="25%" title="Start date">Fecha de inicio</td>
			<td class="h" width="25%" title="End date">Fecha final</td>
	...
	<tbody>
		<tr>
			<td colspan="6" align="center" style="padding:16px 0; color: #666">Sin sesiones.</td>
		</tr>
	</tbody>
