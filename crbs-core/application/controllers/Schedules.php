...
class Schedules extends MY_Controller
{
	...
	{
		$items = [
			['schedules', 'Horarios', 'school_manage_times.png'],
		];
	...
	{
		$this->data['title'] = 'Editar Horarios';
		$this->data['showtitle'] = $this->data['title'];
	...
	public function delete($id)
	{
		...
		$this->data['text'] = 'Todas las reservas de salas que utilicen este horario, y las reservas que correspondan a periodos de este calendario, serán eliminadas';

		$this->data['title'] = sprintf('Borrar horario (%s)', html_escape($schedule->name));
