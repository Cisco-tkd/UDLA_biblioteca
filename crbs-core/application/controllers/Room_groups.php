...
class Room_groups extends MY_Controller
{
	...
	public function __construct()
	{
		...
		$this->data['showtitle'] = 'Salas';

		$this->data['rooms_icons'] = [
			['rooms', 'Salas', 'school_manage_rooms.png'],
			feature('room_groups')
			 	? ['room_groups', 'Grupos', 'folder.png']
			 	: null
			 	,
			['rooms/fields', 'Campos Personalizados', 'room_fields.png'],
			['access_control', 'Control de acceso', 'key.png'],
		];
	}
	...
	public function add()
	{
		$this->data['title'] = 'Agregar grupo de salas';
	...
	public function delete($id)
	{
		...
		$this->data['text'] = 'Todas las habitaciones de este grupo se conservarán, pero no pertenecerán a ningún grupo.';
