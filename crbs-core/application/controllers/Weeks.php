...
class Weeks extends MY_Controller
{
	...
	public function index()
	{
		...
		$this->data['title'] = $this->data['showtitle'] = 'Horario Semanal';
	...
	public function add()
	{
		$this->data['title'] = $this->data['showtitle'] = 'Agregar Horario Semanal';
	...
	function edit($id)
	{
		...
		$this->data['title'] = $this->data['showtitle'] = 'Editar semana';
	...
	function delete($id)
	{
		...
		$this->data['text'] = 'Si eliminas esta semana, <strong>todas las reservas recurrentes</strong> que tengan lugar esta semana se eliminarán permanentemente.';
